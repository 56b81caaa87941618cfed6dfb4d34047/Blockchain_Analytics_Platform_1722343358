...
*/
Vue.component("simple_footer_component_1722343359", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BlockScan - Decentralized Blockchain Analytics
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with BlockScan's cutting-edge blockchain analysis tools. Our platform provides real-time insights into emerging blockchain data, helping you make informed decisions and capitalize on new opportunities. Explore the future of blockchain today.
                    </div>
                </div>
            </div>
        </footer> 
